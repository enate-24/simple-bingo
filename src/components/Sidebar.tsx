import { Trophy, Wallet, LogOut, Menu, X, Shield, Settings } from 'lucide-react';
...
interface SidebarProps {
  currentPage: 'game' | 'balance' | 'admin' | 'settings';
  onNavigate: (page: 'game' | 'balance' | 'admin' | 'settings') => void;
  user: User;
  onLogout: () => void;
}
